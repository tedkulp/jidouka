                ...
                {({ loading, error, data }) => {
                    ...
                    return (
                        <div>
                            ...
                            <Button variant="outlined" href={this.generateOauthUrl('streamer', data.config)}>Authenticate to Twitch</Button>

                            <h3>Bot</h3>

                            <Button variant="outlined" href={this.generateOauthUrl('bot', data.config)}>Authenticate to Twitch</Button>
                        </div>
                    );
                }}
            </Query>
