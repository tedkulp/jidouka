...
// import { findModerationIssues, countEmotes, countBlacklistedWords } from '../../extensions/system/moderation';
...
//             const issues = await findModerationIssues(message, userState);
